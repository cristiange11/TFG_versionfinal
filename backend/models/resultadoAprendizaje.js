...
module.exports = class ResultadoAprendizaje {
    ...
    //Método utilizado para obtener informacion de un rsultado de aprendizaje
    static async getResultadoAprendizajes(codigoModulo) {
        const connection = await promisePool.connection();
        const [rows, fields] = await connection.query(`SELECT * FROM resultado_aprendizaje where codigoModulo = ${connection.escape(codigoModulo)}`);
