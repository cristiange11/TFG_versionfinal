...
export class EditProfileComponent implements OnInit {
  editForm: FormGroup;
  //Variables utilizadas para hacer visible o no las contraseñas
  hide = true;
  hide2 = true;
  hide3 = true;
  //Variable para conocer el rol 
  numero;
  user;
  ...
  //Método para cargar el usuario que ha iniciado sesión, el formulario con sus validators y obtener los campos del form rellenos con los datos del usuario
  ngOnInit(): void {
  ...
  //Método para comprobar si las contraseñas son iguales
  ...
  //Crear el formgroup con los distintos validatos
  ...
  //Método para representar los errores dle formulario
