...
export class EncuestaUpdateComponent implements OnInit {
  ...
  resultado;
  constructor(public resultadoService: ResultadoEncuestaService, public dialogRef: MatDialogRef<EncuestaUpdateComponent>, 
  ...
  //Método utilizado para obtener los resultados de encuesta
  ngOnInit(): void {
  ...
  //Método utilizado para actualizar la encuesta
  save() {
